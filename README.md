...
cast send 0x35Bcf3c30594191d53231E4FF333E8A770453e40 \
  "setRewardCaller(address)" <LIVEPEER_REWARD_CALLER_ADDRESS> \
  --rpc-url https://arb1.arbitrum.io/rpc --ledger
```

Then put your key back in the freezer. That's it.

> Deployed address: **TBD — not yet deployed.** Will be published here, on livepeer.bot, and
> announced on the Livepeer forum once the canary run completes.
